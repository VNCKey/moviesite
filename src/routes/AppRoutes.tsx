...
import EditCines from "../features/cines/components/EditCine";
...
const AppRoutes = () => {
  return (
    <Routes>
      ...
      <Route path="/genders" element={<IndexGenres />} />
      <Route path="/genders/create" element={<CreateGender />} />
      <Route path="/genders/edit/:id" element={<EditGender />} />
